...
"use strict";var _utility=require("./utility"),one=(0,_utility.random)(10),two=(0,_utility.random)(29),init=function(){console.log("".concat(one," ").concat(two))};setInterval(init,2e3);
